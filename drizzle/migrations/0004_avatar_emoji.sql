...
-- The custom-emoji sticker sets we own, used to pool avatars (a set holds up to
-- 200 emoji). `sticker_count` tracks fill so we can pick a set with room left
-- and roll over to a new one when it fills up.
